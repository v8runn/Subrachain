...
class Transaction:
    ...
    @staticmethod
    def from_json(transcation_json):
          return Transaction(**transcation_json)

    @staticmethod
    def is_valid_transaction(transaction):
          """
          Validate a transaction and invalidates an invalid one
          """
...
def main():
      ...
      print(f'restored transcation: {restored_transaction.__dict__}')
