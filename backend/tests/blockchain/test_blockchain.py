...
def test_valid_trans_chain(blockchain_three_blocks):
    Blockchain.is_valid_transaction_chain(blockchain_three_blocks.chain)

def test_is_valid_transaction_chain_duplicate(blockchain_three_blocks):
...
def test_is_valid_transaction_mulreward(blockchain_three_blocks):
...
def test_is_valid_trans_bad_trans(blockchain_three_blocks):
